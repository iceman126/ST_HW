...
@.str1 = private unnamed_addr constant [2 x i8] c"l\00", align 1
...
@.str4 = private unnamed_addr constant [60 x i8] c"/home/klee/klee_src/runtime/Intrinsic/klee_div_zero_check.c\00", align 1
...
define void @_Z10commissioniii(%"class.std::basic_string"* noalias sret %agg.result, i32 %locks, i32 %stocks, i32 %barrels) #3 {
  ...
  store double 0.000000e+00, double* %c, align 8, !dbg !851
  %9 = load i32* %1, align 4, !dbg !853
  %10 = mul nsw i32 %9, 45, !dbg !853
  %11 = load i32* %2, align 4, !dbg !853
  %12 = mul nsw i32 %11, 30, !dbg !853
  %13 = add nsw i32 %10, %12, !dbg !853
  %14 = load i32* %3, align 4, !dbg !853
  %15 = mul nsw i32 %14, 25, !dbg !853
  %16 = add nsw i32 %13, %15, !dbg !853
  %17 = sitofp i32 %16 to double, !dbg !853
  store double %17, double* %total, align 8, !dbg !853
  %18 = load double* %total, align 8, !dbg !854
  %19 = fcmp ogt double %18, 1.800000e+03, !dbg !854
  %20 = load double* %total, align 8, !dbg !856
  br i1 %19, label %21, label %26, !dbg !854

; <label>:21                                      ; preds = %0
  %22 = fsub double %20, 1.800000e+03, !dbg !856
  %23 = fmul double %22, 2.000000e-01, !dbg !856
  %24 = fadd double %23, 1.200000e+02, !dbg !856
  %25 = fadd double %24, 1.000000e+02, !dbg !856
  store double %25, double* %c, align 8, !dbg !856
  br label %35, !dbg !858

; <label>:26                                      ; preds = %0
  %27 = fcmp ogt double %20, 1.000000e+03, !dbg !859
  %28 = load double* %total, align 8, !dbg !861
  br i1 %27, label %29, label %33, !dbg !859

; <label>:29                                      ; preds = %26
  %30 = fsub double %28, 1.000000e+03, !dbg !861
  %31 = fmul double %30, 1.500000e-01, !dbg !861
  %32 = fadd double %31, 1.000000e+02, !dbg !861
  store double %32, double* %c, align 8, !dbg !861
  br label %35, !dbg !863

; <label>:33                                      ; preds = %26
  %34 = fmul double %28, 1.000000e-01, !dbg !864
  store double %34, double* %c, align 8, !dbg !864
  br label %35

; <label>:35                                      ; preds = %29, %33, %21
  %36 = call i32 @_ZStorSt13_Ios_OpenmodeS_(i32 16, i32 8), !dbg !866
  call void @_ZNSt18basic_stringstreamIcSt11char_traitsIcESaIcEEC1ESt13_Ios_Openmode(%"class.std::basic_stringstream"* %ss, i32 %36), !dbg !866
  %37 = bitcast %"class.std::basic_stringstream"* %ss to i8*, !dbg !867
  %38 = getelementptr inbounds i8* %37, i64 16, !dbg !867
  %39 = bitcast i8* %38 to %"class.std::basic_ostream"*, !dbg !867
  %40 = load double* %c, align 8, !dbg !867
  %41 = invoke %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %39, double %40)
          to label %42 unwind label %46, !dbg !867

; <label>:42                                      ; preds = %35
  store i1 false, i1* %6, !dbg !868
  invoke void @_ZNKSt18basic_stringstreamIcSt11char_traitsIcESaIcEE3strEv(%"class.std::basic_string"* sret %7, %"class.std::basic_stringstream"* %ss)
          to label %43 unwind label %46, !dbg !868

; <label>:43                                      ; preds = %42
  invoke void @_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_EPKS3_OS6_(%"class.std::basic_string"* sret %agg.result, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), %"class.std::basic_string"* %7)
          to label %44 unwind label %50, !dbg !868

; <label>:44                                      ; preds = %43
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %7) #2, !dbg !868
  store i1 true, i1* %6, !dbg !869
  store i32 1, i32* %8
  %45 = load i1* %6, !dbg !870
  br i1 %45, label %55, label %54, !dbg !870

; <label>:46                                      ; preds = %42, %35
  %47 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup, !dbg !870
  %48 = extractvalue { i8*, i32 } %47, 0, !dbg !870
  store i8* %48, i8** %4, !dbg !870
  %49 = extractvalue { i8*, i32 } %47, 1, !dbg !870
  store i32 %49, i32* %5, !dbg !870
  br label %56, !dbg !870

; <label>:50                                      ; preds = %43
  %51 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup, !dbg !870
  %52 = extractvalue { i8*, i32 } %51, 0, !dbg !870
  store i8* %52, i8** %4, !dbg !870
  %53 = extractvalue { i8*, i32 } %51, 1, !dbg !870
  store i32 %53, i32* %5, !dbg !870
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %7) #2, !dbg !870
  br label %56, !dbg !870

; <label>:54                                      ; preds = %44
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %agg.result) #2, !dbg !870
  br label %55, !dbg !870

; <label>:55                                      ; preds = %54, %44
  call void @_ZNSt18basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev(%"class.std::basic_stringstream"* %ss) #2, !dbg !870
  ret void, !dbg !870

; <label>:56                                      ; preds = %50, %46
  call void @_ZNSt18basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev(%"class.std::basic_stringstream"* %ss) #2, !dbg !870
  %57 = load i8** %4, !dbg !870
  %58 = load i32* %5, !dbg !870
  %59 = insertvalue { i8*, i32 } undef, i8* %57, 0, !dbg !870
  %60 = insertvalue { i8*, i32 } %59, i32 %58, 1, !dbg !870
  resume { i8*, i32 } %60, !dbg !870
}
...
define linkonce_odr i32 @_ZStorSt13_Ios_OpenmodeS_(i32 %__a, i32 %__b) #5 {
  ...
  %3 = load i32* %1, align 4, !dbg !871
  %4 = load i32* %2, align 4, !dbg !871
  %5 = or i32 %3, %4, !dbg !871
  ret i32 %5, !dbg !871
}
...
define linkonce_odr void @_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_EPKS3_OS6_(%"class.std::basic_string"* noalias sret %agg.result, i8* %__lhs, %"class.std::basic_string"* %__rhs) #6 {
  ...
  %3 = load %"class.std::basic_string"** %2, align 8, !dbg !873
  %4 = load i8** %1, align 8, !dbg !873
  %5 = call %"class.std::basic_string"* @_ZNSs6insertEmPKc(%"class.std::basic_string"* %3, i64 0, i8* %4), !dbg !873
  %6 = call %"class.std::basic_string"* @_ZSt4moveIRSsEONSt16remove_referenceIT_E4typeEOS2_(%"class.std::basic_string"* %5) #2, !dbg !873
  call void @_ZNSsC1EOSs(%"class.std::basic_string"* %agg.result, %"class.std::basic_string"* %6) #2, !dbg !873
  ret void, !dbg !873
}
...
define i32 @main() #3 {
  ...
  %2 = alloca %"class.std::basic_string", align 8
  store i32 0, i32* %1
  %3 = bitcast i16* %l to i8*, !dbg !875
  call void @klee_make_symbolic(i8* %3, i64 2, i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0)), !dbg !875
  %4 = bitcast i16* %s to i8*, !dbg !876
  call void @klee_make_symbolic(i8* %4, i64 2, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !dbg !876
  %5 = bitcast i16* %b to i8*, !dbg !877
  call void @klee_make_symbolic(i8* %5, i64 2, i8* getelementptr inbounds ([2 x i8]* @.str3, i32 0, i32 0)), !dbg !877
  %6 = load i16* %l, align 2, !dbg !878
  %7 = sext i16 %6 to i32, !dbg !878
  %8 = load i16* %s, align 2, !dbg !878
  %9 = sext i16 %8 to i32, !dbg !878
  %10 = load i16* %b, align 2, !dbg !878
  %11 = sext i16 %10 to i32, !dbg !878
  call void @_Z10commissioniii(%"class.std::basic_string"* sret %2, i32 %7, i32 %9, i32 %11), !dbg !878
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %2) #2, !dbg !878
  ret i32 0, !dbg !879
}
...
define linkonce_odr %"class.std::basic_string"* @_ZSt4moveIRSsEONSt16remove_referenceIT_E4typeEOS2_(%"class.std::basic_string"* %__t) #7 {
  ...
  %2 = load %"class.std::basic_string"** %1, align 8, !dbg !880
  ret %"class.std::basic_string"* %2, !dbg !880
}

declare %"class.std::basic_string"* @_ZNSs6insertEmPKc(%"class.std::basic_string"*, i64, i8*) #0

define internal void @_GLOBAL__I_a() section ".text.startup" {
  call void @__cxx_global_var_init(), !dbg !882
  ret void, !dbg !882
}

; Function Attrs: nounwind uwtable
define void @klee_div_zero_check(i64 %z) #8 {
  %1 = icmp eq i64 %z, 0, !dbg !883
  br i1 %1, label %2, label %3, !dbg !883

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([60 x i8]* @.str4, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str15, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str26, i64 0, i64 0)) #11, !dbg !885
  unreachable, !dbg !885
...
define i32 @klee_int(i8* %name) #8 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !887
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #12, !dbg !887
  %2 = load i32* %x, align 4, !dbg !888, !tbaa !889
  ret i32 %2, !dbg !888
}

; Function Attrs: nounwind uwtable
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #8 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !893
  br i1 %1, label %3, label %2, !dbg !893

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str37, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #11, !dbg !895
  unreachable, !dbg !895
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #8 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !898
  br i1 %1, label %3, label %2, !dbg !898

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([51 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #11, !dbg !900
  unreachable, !dbg !900

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !901
  %5 = icmp eq i32 %4, %end, !dbg !901
  br i1 %5, label %21, label %6, !dbg !901

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !903
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #12, !dbg !903
  %8 = icmp eq i32 %start, 0, !dbg !905
  %9 = load i32* %x, align 4, !dbg !907, !tbaa !889
  br i1 %8, label %10, label %13, !dbg !905

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !907
  %12 = zext i1 %11 to i64, !dbg !907
  call void @klee_assume(i64 %12) #12, !dbg !907
  br label %19, !dbg !909

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !910
  %15 = zext i1 %14 to i64, !dbg !910
  call void @klee_assume(i64 %15) #12, !dbg !910
  %16 = load i32* %x, align 4, !dbg !912, !tbaa !889
  %17 = icmp slt i32 %16, %end, !dbg !912
  %18 = zext i1 %17 to i64, !dbg !912
  call void @klee_assume(i64 %18) #12, !dbg !912
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !913, !tbaa !889
  br label %21, !dbg !913
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #8 {
  %1 = icmp eq i64 %len, 0, !dbg !915
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !915
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !916
  %wide.load = load <16 x i8>* %3, align 1, !dbg !916
  %next.gep.sum279 = or i64 %index, 16, !dbg !916
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !916
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !916
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !916
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !916
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !916
  %next.gep103.sum296 = or i64 %index, 16, !dbg !916
  %7 = getelementptr i8* %destaddr, i64 %next.gep103.sum296, !dbg !916
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !916
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !916
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !917
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !915
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !916
  %12 = load i8* %src.03, align 1, !dbg !916, !tbaa !920
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !916
  store i8 %12, i8* %dest.02, align 1, !dbg !916, !tbaa !920
  %14 = icmp eq i64 %10, 0, !dbg !915
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !915, !llvm.loop !921

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !922
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #8 {
  %1 = icmp eq i8* %src, %dst, !dbg !923
  br i1 %1, label %.loopexit, label %2, !dbg !923

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !925
  br i1 %3, label %.preheader, label %18, !dbg !925

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !927
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !927
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !927
  %wide.load = load <16 x i8>* %6, align 1, !dbg !927
  %next.gep.sum586 = or i64 %index, 16, !dbg !927
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !927
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !927
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !927
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !927
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !927
  %next.gep110.sum603 = or i64 %index, 16, !dbg !927
  %10 = getelementptr i8* %dst, i64 %next.gep110.sum603, !dbg !927
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !927
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !927
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !929
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !927
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !927
  %15 = load i8* %b.04, align 1, !dbg !927, !tbaa !920
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !927
  store i8 %15, i8* %a.03, align 1, !dbg !927, !tbaa !920
  %17 = icmp eq i64 %13, 0, !dbg !927
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !927, !llvm.loop !930

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !931
  %20 = icmp eq i64 %count, 0, !dbg !933
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !933

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !934
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !931
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !933
  %24 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !933
  %25 = bitcast i8* %24 to <16 x i8>*, !dbg !933
  %wide.load434 = load <16 x i8>* %25, align 1, !dbg !933
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !933
  %.sum505 = add i64 %.sum440, -31, !dbg !933
  %26 = getelementptr i8* %src, i64 %.sum505, !dbg !933
  %27 = bitcast i8* %26 to <16 x i8>*, !dbg !933
  %wide.load435 = load <16 x i8>* %27, align 1, !dbg !933
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !933
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !933
  %next.gep333.sum = add i64 %.sum472, -15, !dbg !933
  %28 = getelementptr i8* %dst, i64 %next.gep333.sum, !dbg !933
  %29 = bitcast i8* %28 to <16 x i8>*, !dbg !933
  store <16 x i8> %reverse437, <16 x i8>* %29, align 1, !dbg !933
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !933
  %.sum507 = add i64 %.sum472, -31, !dbg !933
  %30 = getelementptr i8* %dst, i64 %.sum507, !dbg !933
  %31 = bitcast i8* %30 to <16 x i8>*, !dbg !933
  store <16 x i8> %reverse438, <16 x i8>* %31, align 1, !dbg !933
  %index.next234 = add i64 %index212, 32
  %32 = icmp eq i64 %index.next234, %n.vec215
  br i1 %32, label %middle.block210, label %vector.body209, !llvm.loop !935
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %33 = add i64 %.16, -1, !dbg !933
  %34 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !933
  %35 = load i8* %b.18, align 1, !dbg !933, !tbaa !920
  %36 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !933
  store i8 %35, i8* %a.17, align 1, !dbg !933, !tbaa !920
  %37 = icmp eq i64 %33, 0, !dbg !933
  br i1 %37, label %.loopexit, label %scalar.ph211, !dbg !933, !llvm.loop !936
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #8 {
  %1 = icmp eq i64 %len, 0, !dbg !938
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !938
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !939
  %wide.load = load <16 x i8>* %3, align 1, !dbg !939
  %next.gep.sum280 = or i64 %index, 16, !dbg !939
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !939
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !939
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !939
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !939
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !939
  %next.gep104.sum297 = or i64 %index, 16, !dbg !939
  %7 = getelementptr i8* %destaddr, i64 %next.gep104.sum297, !dbg !939
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !939
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !939
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !940
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !938
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !939
  %12 = load i8* %src.03, align 1, !dbg !939, !tbaa !920
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !939
  store i8 %12, i8* %dest.02, align 1, !dbg !939, !tbaa !920
  %14 = icmp eq i64 %10, 0, !dbg !938
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !938, !llvm.loop !941
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !942
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #8 {
  %1 = icmp eq i64 %count, 0, !dbg !943
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !943

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !944
  br label %3, !dbg !943

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !943
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !944
  store volatile i8 %2, i8* %a.02, align 1, !dbg !944, !tbaa !920
  %6 = icmp eq i64 %4, 0, !dbg !943
  br i1 %6, label %._crit_edge, label %3, !dbg !943
...
!719 = metadata !{i32 786478, metadata !1, metadata !715, metadata !"main", metadata !"main", metadata !"", i32 61, metadata !720, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !640, i32 61} ; [ DW_TAG_subp
...
!851 = metadata !{i32 40, i32 0, metadata !852, null}
!852 = metadata !{i32 786443, metadata !1, metadata !714} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!853 = metadata !{i32 41, i32 0, metadata !852, null}
!854 = metadata !{i32 43, i32 0, metadata !855, null}
!855 = metadata !{i32 786443, metadata !1, metadata !852, i32 43, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!856 = metadata !{i32 44, i32 0, metadata !857, null}
!857 = metadata !{i32 786443, metadata !1, metadata !855, i32 43, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!858 = metadata !{i32 45, i32 0, metadata !857, null}
!859 = metadata !{i32 46, i32 0, metadata !860, null}
!860 = metadata !{i32 786443, metadata !1, metadata !855, i32 46, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!861 = metadata !{i32 47, i32 0, metadata !862, null}
!862 = metadata !{i32 786443, metadata !1, metadata !860, i32 46, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!863 = metadata !{i32 48, i32 0, metadata !862, null}
!864 = metadata !{i32 50, i32 0, metadata !865, null}
!865 = metadata !{i32 786443, metadata !1, metadata !860, i32 49, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!866 = metadata !{i32 53, i32 0, metadata !852, null}
!867 = metadata !{i32 54, i32 0, metadata !852, null}
!868 = metadata !{i32 56, i32 0, metadata !852, null}
!869 = metadata !{i32 57, i32 0, metadata !852, null}
!870 = metadata !{i32 58, i32 0, metadata !852, null} ; [ DW_TAG_imported_module ]
!871 = metadata !{i32 124, i32 0, metadata !872, null}
!872 = metadata !{i32 786443, metadata !4, metadata !733} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission//usr/bin/../lib/gcc/x86_64-linux-gnu/4.8/../../../../include/c++/4.8/bits/ios_base.h]
!873 = metadata !{i32 2456, i32 0, metadata !874, null}
!874 = metadata !{i32 786443, metadata !36, metadata !722} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission//usr/bin/../lib/gcc/x86_64-linux-gnu/4.8/../../../../include/c++/4.8/bits/basic_string.h]
!875 = metadata !{i32 63, i32 0, metadata !719, null}
!876 = metadata !{i32 65, i32 0, metadata !719, null}
!877 = metadata !{i32 67, i32 0, metadata !719, null}
!878 = metadata !{i32 68, i32 0, metadata !719, null}
!879 = metadata !{i32 69, i32 0, metadata !719, null}
!880 = metadata !{i32 102, i32 0, metadata !881, null}
!881 = metadata !{i32 786443, metadata !726, metadata !725} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission//usr/bin/../lib/gcc/x86_64-linux-gnu/4.8/../../../../include/c++/4.8/bits/move.h]
!882 = metadata !{i32 124, i32 0, metadata !736, null}
!883 = metadata !{i32 13, i32 0, metadata !884, null}
!884 = metadata !{i32 786443, metadata !747, metadata !749, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_div_zero_check.c]
!885 = metadata !{i32 14, i32 0, metadata !884, null}
!886 = metadata !{i32 15, i32 0, metadata !749, null}
!887 = metadata !{i32 15, i32 0, metadata !759, null}
!888 = metadata !{i32 16, i32 0, metadata !759, null}
!889 = metadata !{metadata !890, metadata !890, i64 0}
!890 = metadata !{metadata !"int", metadata !891, i64 0}
!891 = metadata !{metadata !"omnipotent char", metadata !892, i64 0}
!892 = metadata !{metadata !"Simple C/C++ TBAA"}
!893 = metadata !{i32 21, i32 0, metadata !894, null}
!894 = metadata !{i32 786443, metadata !767, metadata !769, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!895 = metadata !{i32 27, i32 0, metadata !896, null}
!896 = metadata !{i32 786443, metadata !767, metadata !894, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!897 = metadata !{i32 29, i32 0, metadata !769, null}
!898 = metadata !{i32 16, i32 0, metadata !899, null}
!899 = metadata !{i32 786443, metadata !778, metadata !780, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!900 = metadata !{i32 17, i32 0, metadata !899, null}
!901 = metadata !{i32 19, i32 0, metadata !902, null}
!902 = metadata !{i32 786443, metadata !778, metadata !780, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!903 = metadata !{i32 22, i32 0, metadata !904, null}
!904 = metadata !{i32 786443, metadata !778, metadata !902, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!905 = metadata !{i32 25, i32 0, metadata !906, null}
!906 = metadata !{i32 786443, metadata !778, metadata !904, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!907 = metadata !{i32 26, i32 0, metadata !908, null}
!908 = metadata !{i32 786443, metadata !778, metadata !906, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!909 = metadata !{i32 27, i32 0, metadata !908, null}
!910 = metadata !{i32 28, i32 0, metadata !911, null}
!911 = metadata !{i32 786443, metadata !778, metadata !906, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!912 = metadata !{i32 29, i32 0, metadata !911, null}
!913 = metadata !{i32 32, i32 0, metadata !904, null}
!914 = metadata !{i32 34, i32 0, metadata !780, null}
!915 = metadata !{i32 16, i32 0, metadata !792, null}
!916 = metadata !{i32 17, i32 0, metadata !792, null}
!917 = metadata !{metadata !917, metadata !918, metadata !919}
!918 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!919 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!920 = metadata !{metadata !891, metadata !891, i64 0}
!921 = metadata !{metadata !921, metadata !918, metadata !919}
!922 = metadata !{i32 18, i32 0, metadata !792, null}
!923 = metadata !{i32 16, i32 0, metadata !924, null}
!924 = metadata !{i32 786443, metadata !805, metadata !807, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!925 = metadata !{i32 19, i32 0, metadata !926, null}
!926 = metadata !{i32 786443, metadata !805, metadata !807, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!927 = metadata !{i32 20, i32 0, metadata !928, null}
!928 = metadata !{i32 786443, metadata !805, metadata !926, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!929 = metadata !{metadata !929, metadata !918, metadata !919}
!930 = metadata !{metadata !930, metadata !918, metadata !919}
!931 = metadata !{i32 22, i32 0, metadata !932, null}
!932 = metadata !{i32 786443, metadata !805, metadata !926, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!933 = metadata !{i32 24, i32 0, metadata !932, null}
!934 = metadata !{i32 23, i32 0, metadata !932, null}
!935 = metadata !{metadata !935, metadata !918, metadata !919}
!936 = metadata !{metadata !936, metadata !918, metadata !919}
!937 = metadata !{i32 28, i32 0, metadata !807, null}
!938 = metadata !{i32 15, i32 0, metadata !821, null}
!939 = metadata !{i32 16, i32 0, metadata !821, null}
!940 = metadata !{metadata !940, metadata !918, metadata !919}
!941 = metadata !{metadata !941, metadata !918, metadata !919}
!942 = metadata !{i32 17, i32 0, metadata !821, null}
!943 = metadata !{i32 13, i32 0, metadata !835, null}
!944 = metadata !{i32 14, i32 0, metadata !835, null}
!945 = metadata !{i32 15, i32 0, metadata !835, null}
