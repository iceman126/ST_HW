...
define void @_Z10commissioniii(%"class.std::basic_string"* noalias sret %agg.result, i32 %locks, i32 %stocks, i32 %barrels) #3 {
  ...
  invoke void @_ZNSsC1EPKcRKSaIcE(%"class.std::basic_string"* %error_msg, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0), %"class.std::allocator"* %4)
          to label %9 unwind label %24, !dbg !851
...
; <label>:9                                       ; preds = %0
  ...
  %14 = load i32* %2, align 4, !dbg !855
  %15 = icmp slt i32 %14, 1, !dbg !855
  %16 = load i32* %2, align 4, !dbg !855
  %17 = icmp sgt i32 %16, 80, !dbg !855
  %or.cond3 = or i1 %15, %17, !dbg !855
  %18 = load i32* %3, align 4, !dbg !857
  %19 = icmp slt i32 %18, 1, !dbg !857
  %20 = load i32* %3, align 4, !dbg !857
  %21 = icmp sgt i32 %20, 90, !dbg !857
  %or.cond5 = or i1 %19, %21, !dbg !857
  %22 = call i64 @_ZNKSs6lengthEv(%"class.std::basic_string"* %error_msg) #2, !dbg !859
  %23 = icmp ugt i64 %22, 0, !dbg !859
  br i1 %23, label %28, label %29, !dbg !859

; <label>:24                                      ; preds = %0
  %25 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup, !dbg !861
  %26 = extractvalue { i8*, i32 } %25, 0, !dbg !861
  store i8* %26, i8** %5, !dbg !861
  %27 = extractvalue { i8*, i32 } %25, 1, !dbg !861
  store i32 %27, i32* %6, !dbg !861
  call void @_ZNSaIcED1Ev(%"class.std::allocator"* %4) #2, !dbg !861
  br label %82, !dbg !861

; <label>:28                                      ; preds = %9
  call void @_ZNSsC1EOSs(%"class.std::basic_string"* %agg.result, %"class.std::basic_string"* %error_msg) #2, !dbg !862
  store i32 1, i32* %7
  br label %80, !dbg !862

; <label>:29                                      ; preds = %9
  store double 0.000000e+00, double* %c1, align 8, !dbg !863
  %30 = load i32* %1, align 4, !dbg !864
  %31 = mul nsw i32 %30, 45, !dbg !864
  %32 = load i32* %2, align 4, !dbg !864
  %33 = mul nsw i32 %32, 30, !dbg !864
  %34 = add nsw i32 %31, %33, !dbg !864
  %35 = load i32* %3, align 4, !dbg !864
  %36 = mul nsw i32 %35, 25, !dbg !864
  %37 = add nsw i32 %34, %36, !dbg !864
  %38 = sitofp i32 %37 to double, !dbg !864
  store double %38, double* %total, align 8, !dbg !864
  %39 = load double* %total, align 8, !dbg !865
  %40 = fcmp ogt double %39, 1.800000e+03, !dbg !865
  %41 = load double* %total, align 8, !dbg !867
  br i1 %40, label %42, label %47, !dbg !865

; <label>:42                                      ; preds = %29
  %43 = fsub double %41, 1.800000e+03, !dbg !867
  %44 = fmul double %43, 2.000000e-01, !dbg !867
  %45 = fadd double %44, 1.200000e+02, !dbg !867
  %46 = fadd double %45, 1.000000e+02, !dbg !867
  store double %46, double* %c1, align 8, !dbg !867
  br label %56, !dbg !869

; <label>:47                                      ; preds = %29
  %48 = fcmp ogt double %41, 1.000000e+03, !dbg !870
  %49 = load double* %total, align 8, !dbg !872
  br i1 %48, label %50, label %54, !dbg !870

; <label>:50                                      ; preds = %47
  %51 = fsub double %49, 1.000000e+03, !dbg !872
  %52 = fmul double %51, 1.500000e-01, !dbg !872
  %53 = fadd double %52, 1.000000e+02, !dbg !872
  store double %53, double* %c1, align 8, !dbg !872
  br label %56, !dbg !874

; <label>:54                                      ; preds = %47
  %55 = fmul double %49, 1.000000e-01, !dbg !875
  store double %55, double* %c1, align 8, !dbg !875
  br label %56

; <label>:56                                      ; preds = %50, %54, %42
  %57 = call i32 @_ZStorSt13_Ios_OpenmodeS_(i32 16, i32 8), !dbg !877
  invoke void @_ZNSt18basic_stringstreamIcSt11char_traitsIcESaIcEEC1ESt13_Ios_Openmode(%"class.std::basic_stringstream"* %ss, i32 %57)
          to label %58 unwind label %67, !dbg !877

; <label>:58                                      ; preds = %56
  %59 = bitcast %"class.std::basic_stringstream"* %ss to i8*, !dbg !878
  %60 = getelementptr inbounds i8* %59, i64 16, !dbg !878
  %61 = bitcast i8* %60 to %"class.std::basic_ostream"*, !dbg !878
  %62 = load double* %c1, align 8, !dbg !878
  %63 = invoke %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %61, double %62)
          to label %64 unwind label %71, !dbg !878
...
; <label>:64                                      ; preds = %58
  invoke void @_ZNKSt18basic_stringstreamIcSt11char_traitsIcESaIcEE3strEv(%"class.std::basic_string"* sret %8, %"class.std::basic_stringstream"* %ss)
          to label %65 unwind label %71, !dbg !879

; <label>:65                                      ; preds = %64
  invoke void @_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_EPKS3_OS6_(%"class.std::basic_string"* sret %result, i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0), %"class.std::basic_string"* %8)
          to label %66 unwind label %75, !dbg !879

; <label>:66                                      ; preds = %65
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %8) #2, !dbg !879
  call void @_ZNSsC1EOSs(%"class.std::basic_string"* %agg.result, %"class.std::basic_string"* %result) #2, !dbg !880
  store i32 1, i32* %7
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %result) #2, !dbg !861
  call void @_ZNSt18basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev(%"class.std::basic_stringstream"* %ss) #2, !dbg !861
  br label %80

; <label>:67                                      ; preds = %56
  %68 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup, !dbg !877
  %69 = extractvalue { i8*, i32 } %68, 0, !dbg !877
  store i8* %69, i8** %5, !dbg !877
  %70 = extractvalue { i8*, i32 } %68, 1, !dbg !877
  store i32 %70, i32* %6, !dbg !877
  br label %81, !dbg !877

; <label>:71                                      ; preds = %64, %58
  %72 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup, !dbg !861
  %73 = extractvalue { i8*, i32 } %72, 0, !dbg !861
  store i8* %73, i8** %5, !dbg !861
  %74 = extractvalue { i8*, i32 } %72, 1, !dbg !861
  store i32 %74, i32* %6, !dbg !861
  br label %79, !dbg !861

; <label>:75                                      ; preds = %65
  %76 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup, !dbg !861
  %77 = extractvalue { i8*, i32 } %76, 0, !dbg !861
  store i8* %77, i8** %5, !dbg !861
  %78 = extractvalue { i8*, i32 } %76, 1, !dbg !861
  store i32 %78, i32* %6, !dbg !861
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %8) #2, !dbg !861
  br label %79, !dbg !861
...
; <label>:80                                      ; preds = %66, %28
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %error_msg) #2, !dbg !861
  ret void, !dbg !861
...
; <label>:82                                      ; preds = %81, %24
  %83 = load i8** %5, !dbg !861
  %84 = load i32* %6, !dbg !861
  %85 = insertvalue { i8*, i32 } undef, i8* %83, 0, !dbg !861
  %86 = insertvalue { i8*, i32 } %85, i32 %84, 1, !dbg !861
  resume { i8*, i32 } %86, !dbg !861
}
...
define linkonce_odr i32 @_ZStorSt13_Ios_OpenmodeS_(i32 %__a, i32 %__b) #5 {
  ...
  %3 = load i32* %1, align 4, !dbg !881
  %4 = load i32* %2, align 4, !dbg !881
  %5 = or i32 %3, %4, !dbg !881
  ret i32 %5, !dbg !881
}
...
define linkonce_odr void @_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_EPKS3_OS6_(%"class.std::basic_string"* noalias sret %agg.result, i8* %__lhs, %"class.std::basic_string"* %__rhs) #6 {
  ...
  %3 = load %"class.std::basic_string"** %2, align 8, !dbg !883
  %4 = load i8** %1, align 8, !dbg !883
  %5 = call %"class.std::basic_string"* @_ZNSs6insertEmPKc(%"class.std::basic_string"* %3, i64 0, i8* %4), !dbg !883
  %6 = call %"class.std::basic_string"* @_ZSt4moveIRSsEONSt16remove_referenceIT_E4typeEOS2_(%"class.std::basic_string"* %5) #2, !dbg !883
  call void @_ZNSsC1EOSs(%"class.std::basic_string"* %agg.result, %"class.std::basic_string"* %6) #2, !dbg !883
  ret void, !dbg !883
}
...
define i32 @main() #3 {
  ...
  %2 = alloca %"class.std::basic_string", align 8
  store i32 0, i32* %1
  %3 = bitcast i16* %l to i8*, !dbg !885
  call void @klee_make_symbolic(i8* %3, i64 2, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !dbg !885
  %4 = bitcast i16* %s to i8*, !dbg !886
  call void @klee_make_symbolic(i8* %4, i64 2, i8* getelementptr inbounds ([2 x i8]* @.str3, i32 0, i32 0)), !dbg !886
  %5 = bitcast i16* %b to i8*, !dbg !887
  call void @klee_make_symbolic(i8* %5, i64 2, i8* getelementptr inbounds ([2 x i8]* @.str4, i32 0, i32 0)), !dbg !887
  %6 = load i16* %l, align 2, !dbg !888
  %7 = sext i16 %6 to i32, !dbg !888
  %8 = load i16* %s, align 2, !dbg !888
  %9 = sext i16 %8 to i32, !dbg !888
  %10 = load i16* %b, align 2, !dbg !888
  %11 = sext i16 %10 to i32, !dbg !888
  call void @_Z10commissioniii(%"class.std::basic_string"* sret %2, i32 %7, i32 %9, i32 %11), !dbg !888
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %2) #2, !dbg !888
  ret i32 0, !dbg !889
}
...
define linkonce_odr %"class.std::basic_string"* @_ZSt4moveIRSsEONSt16remove_referenceIT_E4typeEOS2_(%"class.std::basic_string"* %__t) #7 {
  ...
  %2 = load %"class.std::basic_string"** %1, align 8, !dbg !890
  ret %"class.std::basic_string"* %2, !dbg !890
}

declare %"class.std::basic_string"* @_ZNSs6insertEmPKc(%"class.std::basic_string"*, i64, i8*) #0

define internal void @_GLOBAL__I_a() section ".text.startup" {
  call void @__cxx_global_var_init(), !dbg !892
  ret void, !dbg !892
}

; Function Attrs: nounwind uwtable
define void @klee_div_zero_check(i64 %z) #8 {
  %1 = icmp eq i64 %z, 0, !dbg !893
  br i1 %1, label %2, label %3, !dbg !893

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([60 x i8]* @.str5, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str16, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str27, i64 0, i64 0)) #11, !dbg !895
  unreachable, !dbg !895
...
define i32 @klee_int(i8* %name) #8 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !897
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #12, !dbg !897
  %2 = load i32* %x, align 4, !dbg !898, !tbaa !899
  ret i32 %2, !dbg !898
}

; Function Attrs: nounwind uwtable
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #8 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !903
  br i1 %1, label %3, label %2, !dbg !903

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str38, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #11, !dbg !905
  unreachable, !dbg !905
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #8 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !908
  br i1 %1, label %3, label %2, !dbg !908

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([51 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #11, !dbg !910
  unreachable, !dbg !910

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !911
  %5 = icmp eq i32 %4, %end, !dbg !911
  br i1 %5, label %21, label %6, !dbg !911

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !913
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #12, !dbg !913
  %8 = icmp eq i32 %start, 0, !dbg !915
  %9 = load i32* %x, align 4, !dbg !917, !tbaa !899
  br i1 %8, label %10, label %13, !dbg !915

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !917
  %12 = zext i1 %11 to i64, !dbg !917
  call void @klee_assume(i64 %12) #12, !dbg !917
  br label %19, !dbg !919

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !920
  %15 = zext i1 %14 to i64, !dbg !920
  call void @klee_assume(i64 %15) #12, !dbg !920
  %16 = load i32* %x, align 4, !dbg !922, !tbaa !899
  %17 = icmp slt i32 %16, %end, !dbg !922
  %18 = zext i1 %17 to i64, !dbg !922
  call void @klee_assume(i64 %18) #12, !dbg !922
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !923, !tbaa !899
  br label %21, !dbg !923
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #8 {
  %1 = icmp eq i64 %len, 0, !dbg !925
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !925
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !926
  %wide.load = load <16 x i8>* %3, align 1, !dbg !926
  %next.gep.sum279 = or i64 %index, 16, !dbg !926
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !926
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !926
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !926
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !926
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !926
  %next.gep103.sum296 = or i64 %index, 16, !dbg !926
  %7 = getelementptr i8* %destaddr, i64 %next.gep103.sum296, !dbg !926
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !926
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !926
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !927
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !925
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !926
  %12 = load i8* %src.03, align 1, !dbg !926, !tbaa !930
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !926
  store i8 %12, i8* %dest.02, align 1, !dbg !926, !tbaa !930
  %14 = icmp eq i64 %10, 0, !dbg !925
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !925, !llvm.loop !931

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !932
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #8 {
  %1 = icmp eq i8* %src, %dst, !dbg !933
  br i1 %1, label %.loopexit, label %2, !dbg !933

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !935
  br i1 %3, label %.preheader, label %18, !dbg !935

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !937
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !937
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !937
  %wide.load = load <16 x i8>* %6, align 1, !dbg !937
  %next.gep.sum586 = or i64 %index, 16, !dbg !937
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !937
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !937
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !937
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !937
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !937
  %next.gep110.sum603 = or i64 %index, 16, !dbg !937
  %10 = getelementptr i8* %dst, i64 %next.gep110.sum603, !dbg !937
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !937
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !937
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !939
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !937
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !937
  %15 = load i8* %b.04, align 1, !dbg !937, !tbaa !930
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !937
  store i8 %15, i8* %a.03, align 1, !dbg !937, !tbaa !930
  %17 = icmp eq i64 %13, 0, !dbg !937
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !937, !llvm.loop !940

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !941
  %20 = icmp eq i64 %count, 0, !dbg !943
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !943

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !944
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !941
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !943
  %24 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !943
  %25 = bitcast i8* %24 to <16 x i8>*, !dbg !943
  %wide.load434 = load <16 x i8>* %25, align 1, !dbg !943
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !943
  %.sum505 = add i64 %.sum440, -31, !dbg !943
  %26 = getelementptr i8* %src, i64 %.sum505, !dbg !943
  %27 = bitcast i8* %26 to <16 x i8>*, !dbg !943
  %wide.load435 = load <16 x i8>* %27, align 1, !dbg !943
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !943
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !943
  %next.gep333.sum = add i64 %.sum472, -15, !dbg !943
  %28 = getelementptr i8* %dst, i64 %next.gep333.sum, !dbg !943
  %29 = bitcast i8* %28 to <16 x i8>*, !dbg !943
  store <16 x i8> %reverse437, <16 x i8>* %29, align 1, !dbg !943
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !943
  %.sum507 = add i64 %.sum472, -31, !dbg !943
  %30 = getelementptr i8* %dst, i64 %.sum507, !dbg !943
  %31 = bitcast i8* %30 to <16 x i8>*, !dbg !943
  store <16 x i8> %reverse438, <16 x i8>* %31, align 1, !dbg !943
  %index.next234 = add i64 %index212, 32
  %32 = icmp eq i64 %index.next234, %n.vec215
  br i1 %32, label %middle.block210, label %vector.body209, !llvm.loop !945
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %33 = add i64 %.16, -1, !dbg !943
  %34 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !943
  %35 = load i8* %b.18, align 1, !dbg !943, !tbaa !930
  %36 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !943
  store i8 %35, i8* %a.17, align 1, !dbg !943, !tbaa !930
  %37 = icmp eq i64 %33, 0, !dbg !943
  br i1 %37, label %.loopexit, label %scalar.ph211, !dbg !943, !llvm.loop !946
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #8 {
  %1 = icmp eq i64 %len, 0, !dbg !948
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !948
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !949
  %wide.load = load <16 x i8>* %3, align 1, !dbg !949
  %next.gep.sum280 = or i64 %index, 16, !dbg !949
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !949
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !949
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !949
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !949
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !949
  %next.gep104.sum297 = or i64 %index, 16, !dbg !949
  %7 = getelementptr i8* %destaddr, i64 %next.gep104.sum297, !dbg !949
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !949
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !949
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !950
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !948
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !949
  %12 = load i8* %src.03, align 1, !dbg !949, !tbaa !930
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !949
  store i8 %12, i8* %dest.02, align 1, !dbg !949, !tbaa !930
  %14 = icmp eq i64 %10, 0, !dbg !948
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !948, !llvm.loop !951
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !952
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #8 {
  %1 = icmp eq i64 %count, 0, !dbg !953
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !953

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !954
  br label %3, !dbg !953

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !953
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !954
  store volatile i8 %2, i8* %a.02, align 1, !dbg !954, !tbaa !930
  %6 = icmp eq i64 %4, 0, !dbg !953
  br i1 %6, label %._crit_edge, label %3, !dbg !953
...
!719 = metadata !{i32 786478, metadata !1, metadata !715, metadata !"main", metadata !"main", metadata !"", i32 77, metadata !720, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !640, i32 77} ; [ DW_TAG_subp
...
!855 = metadata !{i32 23, i32 0, metadata !856, null}
!856 = metadata !{i32 786443, metadata !1, metadata !852, i32 23, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!857 = metadata !{i32 27, i32 0, metadata !858, null}
!858 = metadata !{i32 786443, metadata !1, metadata !852, i32 27, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!859 = metadata !{i32 33, i32 0, metadata !860, null}
!860 = metadata !{i32 786443, metadata !1, metadata !852, i32 33, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!861 = metadata !{i32 74, i32 0, metadata !852, null}
!862 = metadata !{i32 34, i32 0, metadata !860, null}
!863 = metadata !{i32 56, i32 0, metadata !852, null}
!864 = metadata !{i32 57, i32 0, metadata !852, null}
!865 = metadata !{i32 59, i32 0, metadata !866, null}
!866 = metadata !{i32 786443, metadata !1, metadata !852, i32 59, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!867 = metadata !{i32 60, i32 0, metadata !868, null}
!868 = metadata !{i32 786443, metadata !1, metadata !866, i32 59, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!869 = metadata !{i32 61, i32 0, metadata !868, null}
!870 = metadata !{i32 62, i32 0, metadata !871, null}
!871 = metadata !{i32 786443, metadata !1, metadata !866, i32 62, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!872 = metadata !{i32 63, i32 0, metadata !873, null}
!873 = metadata !{i32 786443, metadata !1, metadata !871, i32 62, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!874 = metadata !{i32 64, i32 0, metadata !873, null}
!875 = metadata !{i32 66, i32 0, metadata !876, null}
!876 = metadata !{i32 786443, metadata !1, metadata !871, i32 65, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission/commission.cpp]
!877 = metadata !{i32 69, i32 0, metadata !852, null}
!878 = metadata !{i32 70, i32 0, metadata !852, null}
!879 = metadata !{i32 72, i32 0, metadata !852, null}
!880 = metadata !{i32 73, i32 0, metadata !852, null}
!881 = metadata !{i32 124, i32 0, metadata !882, null}
!882 = metadata !{i32 786443, metadata !4, metadata !733} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission//usr/bin/../lib/gcc/x86_64-linux-gnu/4.8/../../../../include/c++/4.8/bits/ios_base.h]
!883 = metadata !{i32 2456, i32 0, metadata !884, null}
!884 = metadata !{i32 786443, metadata !36, metadata !722} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission//usr/bin/../lib/gcc/x86_64-linux-gnu/4.8/../../../../include/c++/4.8/bits/basic_string.h]
!885 = metadata !{i32 79, i32 0, metadata !719, null}
!886 = metadata !{i32 81, i32 0, metadata !719, null}
!887 = metadata !{i32 83, i32 0, metadata !719, null}
!888 = metadata !{i32 84, i32 0, metadata !719, null}
!889 = metadata !{i32 85, i32 0, metadata !719, null}
!890 = metadata !{i32 102, i32 0, metadata !891, null}
!891 = metadata !{i32 786443, metadata !726, metadata !725} ; [ DW_TAG_lexical_block ] [/home/klee/ST/commission//usr/bin/../lib/gcc/x86_64-linux-gnu/4.8/../../../../include/c++/4.8/bits/move.h]
!892 = metadata !{i32 124, i32 0, metadata !736, null}
!893 = metadata !{i32 13, i32 0, metadata !894, null}
!894 = metadata !{i32 786443, metadata !747, metadata !749, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_div_zero_check.c]
!895 = metadata !{i32 14, i32 0, metadata !894, null}
!896 = metadata !{i32 15, i32 0, metadata !749, null}
!897 = metadata !{i32 15, i32 0, metadata !759, null}
!898 = metadata !{i32 16, i32 0, metadata !759, null}
!899 = metadata !{metadata !900, metadata !900, i64 0}
!900 = metadata !{metadata !"int", metadata !901, i64 0}
!901 = metadata !{metadata !"omnipotent char", metadata !902, i64 0}
!902 = metadata !{metadata !"Simple C/C++ TBAA"}
!903 = metadata !{i32 21, i32 0, metadata !904, null}
!904 = metadata !{i32 786443, metadata !767, metadata !769, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!905 = metadata !{i32 27, i32 0, metadata !906, null}
!906 = metadata !{i32 786443, metadata !767, metadata !904, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!907 = metadata !{i32 29, i32 0, metadata !769, null}
!908 = metadata !{i32 16, i32 0, metadata !909, null}
!909 = metadata !{i32 786443, metadata !778, metadata !780, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!910 = metadata !{i32 17, i32 0, metadata !909, null}
!911 = metadata !{i32 19, i32 0, metadata !912, null}
!912 = metadata !{i32 786443, metadata !778, metadata !780, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!913 = metadata !{i32 22, i32 0, metadata !914, null}
!914 = metadata !{i32 786443, metadata !778, metadata !912, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!915 = metadata !{i32 25, i32 0, metadata !916, null}
!916 = metadata !{i32 786443, metadata !778, metadata !914, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!917 = metadata !{i32 26, i32 0, metadata !918, null}
!918 = metadata !{i32 786443, metadata !778, metadata !916, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!919 = metadata !{i32 27, i32 0, metadata !918, null}
!920 = metadata !{i32 28, i32 0, metadata !921, null}
!921 = metadata !{i32 786443, metadata !778, metadata !916, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!922 = metadata !{i32 29, i32 0, metadata !921, null}
!923 = metadata !{i32 32, i32 0, metadata !914, null}
!924 = metadata !{i32 34, i32 0, metadata !780, null}
!925 = metadata !{i32 16, i32 0, metadata !792, null}
!926 = metadata !{i32 17, i32 0, metadata !792, null}
!927 = metadata !{metadata !927, metadata !928, metadata !929}
!928 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!929 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!930 = metadata !{metadata !901, metadata !901, i64 0}
!931 = metadata !{metadata !931, metadata !928, metadata !929}
!932 = metadata !{i32 18, i32 0, metadata !792, null}
!933 = metadata !{i32 16, i32 0, metadata !934, null}
!934 = metadata !{i32 786443, metadata !805, metadata !807, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!935 = metadata !{i32 19, i32 0, metadata !936, null}
!936 = metadata !{i32 786443, metadata !805, metadata !807, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!937 = metadata !{i32 20, i32 0, metadata !938, null}
!938 = metadata !{i32 786443, metadata !805, metadata !936, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!939 = metadata !{metadata !939, metadata !928, metadata !929}
!940 = metadata !{metadata !940, metadata !928, metadata !929}
!941 = metadata !{i32 22, i32 0, metadata !942, null}
!942 = metadata !{i32 786443, metadata !805, metadata !936, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!943 = metadata !{i32 24, i32 0, metadata !942, null}
!944 = metadata !{i32 23, i32 0, metadata !942, null}
!945 = metadata !{metadata !945, metadata !928, metadata !929}
!946 = metadata !{metadata !946, metadata !928, metadata !929}
!947 = metadata !{i32 28, i32 0, metadata !807, null}
!948 = metadata !{i32 15, i32 0, metadata !821, null}
!949 = metadata !{i32 16, i32 0, metadata !821, null}
!950 = metadata !{metadata !950, metadata !928, metadata !929}
!951 = metadata !{metadata !951, metadata !928, metadata !929}
!952 = metadata !{i32 17, i32 0, metadata !821, null}
!953 = metadata !{i32 13, i32 0, metadata !835, null}
!954 = metadata !{i32 14, i32 0, metadata !835, null}
!955 = metadata !{i32 15, i32 0, metadata !835, null}
