...
@.str3 = private unnamed_addr constant [36 x i8] c"\0Abarrels should be in range of 1~90\00", align 1
...
; <label>:29                                      ; preds = %24
  %30 = invoke %"class.std::basic_string"* @_ZNSspLEPKc(%"class.std::basic_string"* %error_msg, i8* getelementptr inbounds ([35 x i8]* @.str2, i32 0, i32 0))
...
; <label>:36                                      ; preds = %31
  %37 = invoke %"class.std::basic_string"* @_ZNSspLEPKc(%"class.std::basic_string"* %error_msg, i8* getelementptr inbounds ([36 x i8]* @.str3, i32 0, i32 0))
